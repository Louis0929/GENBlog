...
Generate the three-exchange comparison:

```powershell
python skills/genblog/scripts/run_genblog.py --input data/mock_campaign.json --job-id job_binance_vs_bybit_vs_okx_brazil_bonus --search-provider mock --output-dir outputs/binance-vs-bybit-brazil
```
